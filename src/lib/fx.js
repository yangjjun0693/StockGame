...
export const CURATED_FX = [
  ...
  { id: 'usdjpy', code: 'JPY', name: 'USD/JPY', symbol: 'USD/JPY', sector: '외환', invert: false },
  { id: 'usdkrw', code: 'KRW', name: 'USD/KRW', symbol: 'USD/KRW', sector: '외환', invert: false },
  { id: 'usdchf', code: 'CHF', name: 'USD/CHF', symbol: 'USD/CHF', sector: '외환', invert: false },
];
